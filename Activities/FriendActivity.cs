...
{
    [Activity(Label = "Amigos", ParentActivity = typeof(HomeView))]
    [MetaData("android.support.PARENT_ACTIVITY", Value = "navdrawer.activities.HomeView")]
	public class FriendActivity : MvxAppCompatActivity<FriendViewModel>
    {
		List<Monkey> friends;
        ...
        protected override void OnCreate(Android.OS.Bundle savedInstanceState)
        {
            ...
            title = string.IsNullOrWhiteSpace(title) ? "Novo Amigo" : title;
